...
@Tag(
        name = "REST API for Customers in MicroBank",
        description = "REST APIs in MicroBank to FETCH customer details"
)
@RestController
...
public class CustomerController {
    ...
    public ResponseEntity<CustomerDetailDto> fetchCustomerDetails(@RequestParam
                                                                   ...
                                                                   String mobileNumber){
        CustomerDetailDto customerDetailsDto = customerService.getCustomerDetail(mobileNumber);
